import 'package:detection_engine/intake/candle_normalizer.dart';
import 'package:detection_engine/intake/ticker_resolver.dart';
...
void main() {
  ...
  test('normalizes Alpaca bars', () {
    final candles = normalizer.normalize(
      DataSource.alpaca,
      {
        'bars': [
          {
