...
class GoldenTheme implements HaloThemeData {
  const GoldenTheme();
  ...
  @override
  Color get textAccent => const Color(0xFFF59E0B); // Amber-500

  // ─── Theme identity ───────────────────────────────────────────────────────

  @override
  HaloThemeType get type => HaloThemeType.golden;
  ...
  List<Color> get backgroundGradient => const [
        Color(0xFF3D1500), // rich dark amber-brown
        Color(0xFF210A00), // deep warm anchor
      ];

  @override
  List<Color> get blobColors => const [
    Color(0xFFF59E0B), // amber-500  — bright gold
    Color(0xFFF97316), // orange-500 — vivid orange
    Color(0xFFEAB308), // yellow-500 — bright yellow
    Color(0xFFD97706), // amber-600  — rich amber
    Color(0xFFFBBF24), // amber-400  — light gold shimmer
    Color(0xFFEA580C), // orange-600 — deep orange
  ];
  ...
  @override
  Color get accentColor => const Color(0xFFF2A340);

  @override
  Color get whiteColor => const Color(0xFFF4E9D8);
